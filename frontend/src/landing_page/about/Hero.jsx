...
function Hero() {
    return (
        <div className="container">
            <div style={{textAlign:"center", fontSize:"5px", color:"black", marginTop:"5rem"}}>
                <h2 style={{color:"#5b5959", fontSize:"25px", padding:"25px"}}>We pioneered the discount broking model in India.<br></br>
